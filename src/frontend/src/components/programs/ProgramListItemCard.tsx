  ...
  const getStatusBadge = (status: ProgramStatus) => {
    switch (status) {
      case ProgramStatus.planning:
        return <Badge variant="outline" className="text-xs">Perencanaan</Badge>;
      case ProgramStatus.ongoing:
        return <Badge className="bg-chart-2 text-white text-xs">Berjalan</Badge>;
      case ProgramStatus.completed:
        return <Badge className="bg-chart-3 text-white text-xs">Selesai</Badge>;
      default:
  ...
  const getPriorityBadge = (priority: ProgramPriority) => {
    switch (priority) {
      case ProgramPriority.high:
        return <Badge className="bg-destructive text-white text-xs">Tinggi</Badge>;
      case ProgramPriority.middle:
        return <Badge className="bg-yellow-500 text-white text-xs">Sedang</Badge>;
      case ProgramPriority.low:
        return <Badge className="bg-green-600 text-white text-xs">Rendah</Badge>;
      default:
